...
if(NOT Poco_ROOT_DIR)
	...
	if(NOT Poco_ROOT_DIR)
		...
		message(STATUS "[StructBX] Looking for Poco install directory structure.")
		find_path(Poco_ROOT_DIR 
		...
		if(NOT Poco_ROOT_DIR) 
			...
			if(Poco_FIND_REQUIRED)
				message(FATAL_ERROR "[StructBX] Poco: Could not find Poco install directory")
			endif()
			if(NOT Poco_FIND_QUIETLY)
				message(STATUS "[StructBX] Poco: Could not find Poco install directory")
			endif()
			return()
		else()
			# poco was found with the make install directory structure
			message(STATUS "[StructBX] Assuming Poco install directory structure at ${Poco_ROOT_DIR}.")
...
foreach( component ${components} )
	...
	if(NOT Poco_${component}_INCLUDE_DIR)
		message(FATAL_ERROR "[StructBX] Poco_${component}_INCLUDE_DIR NOT FOUND")
	else()
	...
	if(NOT Poco_${component}_LIBRARY)
		...
		if(Poco_${component}_LIBRARY)
			message(STATUS "[StructBX] Found Poco ${component}: ${Poco_${component}_LIBRARY}")
		endif()
	endif()
	if(Poco_${component}_LIBRARY)
	...
	if(NOT Poco_${component}_LIBRARY_DEBUG)
		...
		if(Poco_${component}_LIBRARY_DEBUG)
			message(STATUS "[StructBX] Found Poco ${component} (debug): ${Poco_${component}_LIBRARY_DEBUG}")
		endif()
	...
	elseif(NOT Poco_FIND_QUIETLY)
		message(FATAL_ERROR "[StructBX] Could not find Poco component ${component}!")
	endif()
...
message(STATUS "[StructBX] Found Poco: ${Poco_LIBRARIES}")

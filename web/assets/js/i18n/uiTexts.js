...
export const uiTexts = {
    ...
    "table.settings_column_display": { en: "Column display", es: "Columna de visualización" },
    "table.settings_column_display_none": { en: "None", es: "Ninguna" },
    "table.settings_column_display_hint": { en: "Column shown in selection type fields", es: "Columna que se muestra en campos tipo selección" },
    "table.column_display_indicator": { en: "Display column", es: "Columna de visualización" },
    ...
    "table.settings_row_policies": { en: "Row security policies", es: "Políticas de seguridad por fila" },
    "table.settings_row_policy_name": { en: "Policy", es: "Política" },
    "table.settings_row_policy_target": { en: "Target", es: "Destino" },
    "table.settings_row_policy_action": { en: "Action", es: "Acción" },
    "table.settings_row_policy_condition": { en: "Condition", es: "Condición" },
    "table.settings_row_policy_active": { en: "Active", es: "Activa" },
    "table.settings_row_policy_target_all": { en: "All users", es: "Todos los usuarios" },
    "table.settings_row_policy_target_user": { en: "Specific user", es: "Usuario específico" },
    "table.settings_row_policy_target_group": { en: "Specific group", es: "Grupo específico" },
    "table.settings_row_policy_target_type": { en: "User type", es: "Tipo de usuario" },
    "table.settings_row_policy_target_id": { en: "Target ID", es: "ID del destino" },
    "table.settings_row_policy_action_filter": { en: "Apply filter", es: "Aplicar filtro" },
    "table.settings_row_policy_action_bypass": { en: "Bypass (no filter)", es: "Sin filtro" },
    "table.settings_row_policy_column": { en: "Column", es: "Columna" },
    "table.settings_row_policy_operator": { en: "Operator", es: "Operador" },
    "table.settings_row_policy_value": { en: "Value", es: "Valor" },
    "table.settings_row_policy_value_hint": { en: "Available placeholders: <code>{current_user_id}</code>, <code>{current_username}</code>, <code>{user_type}</code>, <code>{user_group}</code>", es: "Placeholders disponibles: <code>{current_user_id}</code>, <code>{current_username}</code>, <code>{user_type}</code>, <code>{user_group}</code>" },
    "table.settings_row_policy_priority": { en: "Priority", es: "Prioridad" },
    "table.settings_row_policy_select_column": { en: "Select column...", es: "Seleccionar columna..." },
    "table.settings_row_policy_select_user": { en: "Select user...", es: "Seleccionar usuario..." },
    "table.settings_row_policy_select_group": { en: "Select group...", es: "Seleccionar grupo..." },
    "table.settings_row_policy_select_value": { en: "Select value or placeholder...", es: "Seleccionar valor o marcador..." },
    "table.modal_add_row_policy": { en: "Add row policy", es: "Añadir política de fila" },
    "table.modal_modify_row_policy": { en: "Modify row policy", es: "Modificar política de fila" },
    "table.modal_delete_row_policy": { en: "Delete row policy", es: "Eliminar política de fila" },
    "table.modal_confirm_delete_row_policy": { en: "Are you sure you want to delete this row policy?", es: "¿Seguro desea eliminar esta política de fila?" },
